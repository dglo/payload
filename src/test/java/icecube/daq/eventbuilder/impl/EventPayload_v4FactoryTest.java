...
public class EventPayload_v4FactoryTest
    extends LoggingCase
{
    /**
     ...
     */
    public EventPayload_v4FactoryTest(String name)
    {
        super(name);
    }
    ...
    {
        return new TestSuite(EventPayload_v4FactoryTest.class);
    }
        ...
        throws Exception
    {
        ...
        EventPayload_v4Factory factory = new EventPayload_v4Factory();

        EventPayload_v4 evt =
            (EventPayload_v4) factory.createPayload(uid,
