    ...
    extends AbstractEventPayload
{
     ...
     * Default constructor.
     */
    public EventPayload_v4()
    {
        super(PayloadRegistry.PAYLOAD_ID_EVENT_V4, 4);
    }
    ...
    {
        return (AbstractEventPayloadRecord) EventPayloadRecord_v4.getFromPool();
    }
    ...
    public int getRunNumber()
    {
        ...
        return ((EventPayloadRecord_v4) getRecord()).getRunNumber();
    }
    ...
    public int getSubrunNumber()
    {
        ...
        return ((EventPayloadRecord_v4) getRecord()).getSubrunNumber();
    }
    ...
    public short getYear()
    {
        ...
        return ((EventPayloadRecord_v4) getRecord()).getYear();
    }
    ...
    {
        // build record
        EventPayloadRecord_v4 rec =
            (EventPayloadRecord_v4) EventPayloadRecord_v4.getFromPool();
        rec.initialize(iUID, tSourceID, tFirstTimeUTC, tLastTimeUTC,
                       iYear, iRunNumber, iSubrunNumber);
