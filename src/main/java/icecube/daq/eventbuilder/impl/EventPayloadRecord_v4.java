 ...
 * @author dwharton
 *
 * NOTE: This is now RecordType v4 and includes the following fields
 ...
 *
 */
public class EventPayloadRecord_v4
    extends AbstractEventPayloadRecord
{
    ...
    public static final int SIZE_UNUSED = 2;
    public static final int SIZE_RUN_NUMBER = 4;
    //-The following have been added to the EventPayloadRecord_v4 which
    ...
    public static final int SIZE_TOTAL = SIZE_TOTAL_V1 + SIZE_YEAR +
        SIZE_UNUSED + SIZE_RUN_NUMBER + SIZE_SUBRUN_NUMBER;
    ...
    public static final int OFFSET_YEAR =
        OFFSET_LAST_UTCTIME + SIZE_LAST_UTCTIME;
    public static final int OFFSET_UNUSED =
        OFFSET_YEAR + SIZE_YEAR;
    public static final int OFFSET_RUN_NUMBER =
        OFFSET_UNUSED + SIZE_UNUSED;
    ...
    private short msi_year = (short) -1; //-year in which event occurred
     ...
     */
    public EventPayloadRecord_v4()
    {
        super(RecordTypeRegistry.RECORD_TYPE_EVENT_V4);
    }
    ...
    {
        return new EventPayloadRecord_v4();
    }
     ...
     * @param iYear the year when this event occurred
    ...
    public void initialize(int iUID, ISourceID tSourceID,
                           ...
                           short iYear, int iRunNumber, int iSubrunNumber)
    {
    ...
    public void loadData(int iRecordOffset, ByteBuffer tBuffer)
    {
        ...
        //-read the event type
        msi_year = tBuffer.getShort(iRecordOffset + OFFSET_YEAR);
    ...
    public int writeData(IPayloadDestination tDestination)
        throws IOException
    {
        if (tDestination.doLabel()) tDestination.label("[EventPayloadRecord_v4]=>").indent();
        ...
        tDestination.writeShort(YEAR, msi_year);
        tDestination.writeShort(UNUSED, (short) -1);
    ...
    public int writeData(int iOffset, ByteBuffer tBuffer)
    {
        ...
        tBuffer.putShort(iOffset + OFFSET_YEAR, msi_year);
        tBuffer.putShort(iOffset + OFFSET_UNUSED, (short) -1);
