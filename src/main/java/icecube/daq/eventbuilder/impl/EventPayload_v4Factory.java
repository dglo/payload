 ...
 *  a ByteBuffer.
 *  Note: This creates EventPayload_v4 objects which fullfill the same
 *        interface requirements but through a different format.
 *  @author dwharton
 */
public class EventPayload_v4Factory  extends PayloadFactory {

    /**
     * Log object for this class
     */
    private static final Log mtLog = LogFactory.getLog(EventPayload_v4Factory.class);

    /**
     * Standard Constructor.
     */
    public EventPayload_v4Factory() {
        EventPayload_v4 tPayloadPoolableFactory = (EventPayload_v4) EventPayload_v4.getFromPool();
        tPayloadPoolableFactory.mtParentPayloadFactory = this;
        setPoolablePayloadFactory(tPayloadPoolableFactory);
    }

    /**
     *  This method is used to create an EventPayload_v4 from constituent pieces, instead
     ...
     *  @param iYear the year when the event took place
    ...
    public Payload createPayload(
        ...
        if (tTriggerRequestCopy == null) {
            ...
            tPayload = (EventPayload_v4) EventPayload_v4.getFromPool();
